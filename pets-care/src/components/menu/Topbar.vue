<template>
  <div >
	...
	<a href="/" class="navbar-brand"><i class="fa fa-paw" aria-hidden="true"></i>PETS <b>CARE</b></a>  		
...
//https://itnext.io/build-a-vue-js-drop-down-profile-menu-component-97be8a3d2424
  export default {
	name: 'top-bar',
// 	plugins: [
